# restfriends-sample
Restfriends sample REST API and automated testing example.
...
An overview of the automated testing tools are available [here](https://github.com/BorderTech/restfriends/wiki/Automated-API-Testing---DRAFT).
